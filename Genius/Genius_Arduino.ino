...
// ============================================================
// OBJETOS PARA DEBOUNCE DOS BOTÕES
// ============================================================

// Utilizado para correcao de erro de ruido nos botoes
...
void setup() {
    ...
    // Botao para interrupcao
  	pinMode(buttonPin0, INPUT_PULLUP);
    
    pinMode(buttonPin1, INPUT_PULLUP);
    debouncer1.attach(buttonPin1, INPUT_PULLUP);  // Associa a um bounce
    debouncer1.interval(5); // Intervalo utilizado pelo bounce
    ...
    debouncer4.attach(buttonPin4, INPUT_PULLUP);
...
void piscaLED() {
    ...
    for (int i = 0; i < limiteSequencia; i++) {
        delay(300);
        acendeLed(sequencia[i]); // Pisca o LED correspondente
      Serial.print(sequencia[i]);
    }
